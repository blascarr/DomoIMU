...
// I Simplified this:
uint8_t Domo_IMU::dmpInitialize() {
	// reset device
	DEBUG_PRINTLN(F("\n\nResetting MPU6050..."));
	reset();
...
bool Domo_IMU::dmpPacketAvailable() {
...
uint8_t Domo_IMU::dmpGetAccel(int32_t *data, const uint8_t* packet) {
...
uint8_t Domo_IMU::dmpGetAccel(int16_t *data, const uint8_t* packet) {
    // TODO: accommodate different arrangements of sent data (ONLY default supported now)
    if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t Domo_IMU::dmpGetAccel(VectorInt16 *v, const uint8_t* packet) {
    // TODO: accommodate different arrangements of sent data (ONLY default supported now)
    if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t Domo_IMU::dmpGetQuaternion(int32_t *data, const uint8_t* packet) {
    // TODO: accommodate different arrangements of sent data (ONLY default supported now)
    if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t Domo_IMU::dmpGetQuaternion(int16_t *data, const uint8_t* packet) {
    // TODO: accommodate different arrangements of sent data (ONLY default supported now)
    if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t Domo_IMU::dmpGetQuaternion(Quaternion *q, const uint8_t* packet) {
    // TODO: accommodate different arrangements of sent data (ONLY default supported now)
    int16_t qI[4];
...
uint8_t Domo_IMU::dmpGetGyro(int32_t *data, const uint8_t* packet) {
    // TODO: accommodate different arrangements of sent data (ONLY default supported now)
    if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t Domo_IMU::dmpGetGyro(int16_t *data, const uint8_t* packet) {
    // TODO: accommodate different arrangements of sent data (ONLY default supported now)
    if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t Domo_IMU::dmpGetGyro(VectorInt16 *v, const uint8_t* packet) {
    // TODO: accommodate different arrangements of sent data (ONLY default supported now)
    if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t Domo_IMU::dmpGetLinearAccel(VectorInt16 *v, VectorInt16 *vRaw, VectorFloat *gravity) {
...
uint8_t Domo_IMU::dmpGetLinearAccelInWorld(VectorInt16 *v, VectorInt16 *vReal, Quaternion *q) {
...
uint8_t Domo_IMU::dmpGetGravity(int16_t *data, const uint8_t* packet) {
...
uint8_t Domo_IMU::dmpGetGravity(VectorFloat *v, Quaternion *q) {
...
uint8_t Domo_IMU::dmpGetEuler(float *data, Quaternion *q) {
...
uint8_t Domo_IMU::dmpGetYawPitchRoll(float *data, Quaternion *q, VectorFloat *gravity) {
    // yaw: (about Z axis)
...
uint8_t Domo_IMU::dmpProcessFIFOPacket(const unsigned char *dmpData) {
...
uint8_t Domo_IMU::dmpReadAndProcessFIFOPacket(uint8_t numPackets, uint8_t *processed) {
    uint8_t status;
...
uint16_t Domo_IMU::dmpGetFIFOPacketSize() {
    return dmpPacketSize;
}

uint8_t Domo_IMU::dmpGetCurrentFIFOPacket(uint8_t *data) { // overflow proof
