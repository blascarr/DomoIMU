 ...
 */
IMU_MPU_Base::IMU_MPU_Base(uint8_t address):devAddr(address) {
}
 ...
 */
bool IMU_MPU_Base::testConnection() {
 ...
 */
uint8_t IMU_MPU_Base::getAuxVDDIOLevel() {
 ...
 */
void IMU_MPU_Base::setAuxVDDIOLevel(uint8_t level) {
 ...
 * @see MPU6050_RA_SMPLRT_DIV
 */
void IMU_MPU_Base::setRate(uint8_t rate) {
 ...
 */
uint8_t IMU_MPU_Base::getExternalFrameSync() {
 ...
 */
void IMU_MPU_Base::setExternalFrameSync(uint8_t sync) {
 ...
 */
uint8_t IMU_MPU_Base::getDLPFMode() {
 ...
 * @see MPU6050_CFG_DLPF_CFG_LENGTH
 */
void IMU_MPU_Base::setDLPFMode(uint8_t mode) {
 ...
 */
uint8_t IMU_MPU_Base::getFullScaleGyroRange() {
 ...
 * @see MPU6050_GCONFIG_FS_SEL_LENGTH
 */
void IMU_MPU_Base::setFullScaleGyroRange(uint8_t range) {
 ...
 */
uint8_t IMU_MPU_Base::getAccelXSelfTestFactoryTrim() {
 ...
 */
uint8_t IMU_MPU_Base::getAccelYSelfTestFactoryTrim() {
 ...
 */
uint8_t IMU_MPU_Base::getAccelZSelfTestFactoryTrim() {
 ...
 * @see MPU6050_RA_SELF_TEST_X
 */
uint8_t IMU_MPU_Base::getGyroXSelfTestFactoryTrim() {
 ...
 * @see MPU6050_RA_SELF_TEST_Y
 */
uint8_t IMU_MPU_Base::getGyroYSelfTestFactoryTrim() {
 ...
 * @see MPU6050_RA_SELF_TEST_Z
 */
uint8_t IMU_MPU_Base::getGyroZSelfTestFactoryTrim() {
 ...
 */
bool IMU_MPU_Base::getAccelXSelfTest() {
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
void IMU_MPU_Base::setAccelXSelfTest(bool enabled) {
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
bool IMU_MPU_Base::getAccelYSelfTest() {
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
void IMU_MPU_Base::setAccelYSelfTest(bool enabled) {
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
bool IMU_MPU_Base::getAccelZSelfTest() {
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
void IMU_MPU_Base::setAccelZSelfTest(bool enabled) {
 ...
 */
uint8_t IMU_MPU_Base::getFullScaleAccelRange() {
 ...
 */
void IMU_MPU_Base::setFullScaleAccelRange(uint8_t range) {
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
uint8_t IMU_MPU_Base::getDHPFMode() {
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
void IMU_MPU_Base::setDHPFMode(uint8_t bandwidth) {
 ...
 */
uint8_t IMU_MPU_Base::getFreefallDetectionThreshold() {
 ...
 * @see MPU6050_RA_FF_THR
 */
void IMU_MPU_Base::setFreefallDetectionThreshold(uint8_t threshold) {
 ...
 */
uint8_t IMU_MPU_Base::getFreefallDetectionDuration() {
 ...
 * @see MPU6050_RA_FF_DUR
 */
void IMU_MPU_Base::setFreefallDetectionDuration(uint8_t duration) {
 ...
 */
uint8_t IMU_MPU_Base::getMotionDetectionThreshold() {
 ...
 * @see MPU6050_RA_MOT_THR
 */
void IMU_MPU_Base::setMotionDetectionThreshold(uint8_t threshold) {
 ...
 */
uint8_t IMU_MPU_Base::getMotionDetectionDuration() {
 ...
 * @see MPU6050_RA_MOT_DUR
 */
void IMU_MPU_Base::setMotionDetectionDuration(uint8_t duration) {
 ...
 */
uint8_t IMU_MPU_Base::getZeroMotionDetectionThreshold() {
 ...
 * @see MPU6050_RA_ZRMOT_THR
 */
void IMU_MPU_Base::setZeroMotionDetectionThreshold(uint8_t threshold) {
 ...
 */
uint8_t IMU_MPU_Base::getZeroMotionDetectionDuration() {
 ...
 * @see MPU6050_RA_ZRMOT_DUR
 */
void IMU_MPU_Base::setZeroMotionDetectionDuration(uint8_t duration) {
 ...
 */
bool IMU_MPU_Base::getTempFIFOEnabled() {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void IMU_MPU_Base::setTempFIFOEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
bool IMU_MPU_Base::getXGyroFIFOEnabled() {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void IMU_MPU_Base::setXGyroFIFOEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
bool IMU_MPU_Base::getYGyroFIFOEnabled() {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void IMU_MPU_Base::setYGyroFIFOEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
bool IMU_MPU_Base::getZGyroFIFOEnabled() {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void IMU_MPU_Base::setZGyroFIFOEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
bool IMU_MPU_Base::getAccelFIFOEnabled() {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void IMU_MPU_Base::setAccelFIFOEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
bool IMU_MPU_Base::getSlave2FIFOEnabled() {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void IMU_MPU_Base::setSlave2FIFOEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
bool IMU_MPU_Base::getSlave1FIFOEnabled() {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void IMU_MPU_Base::setSlave1FIFOEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
bool IMU_MPU_Base::getSlave0FIFOEnabled() {
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void IMU_MPU_Base::setSlave0FIFOEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getMultiMasterEnabled() {
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
void IMU_MPU_Base::setMultiMasterEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
bool IMU_MPU_Base::getWaitForExternalSensorEnabled() {
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
void IMU_MPU_Base::setWaitForExternalSensorEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getSlave3FIFOEnabled() {
 ...
 * @see MPU6050_RA_MST_CTRL
 */
void IMU_MPU_Base::setSlave3FIFOEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
bool IMU_MPU_Base::getSlaveReadWriteTransitionEnabled() {
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
void IMU_MPU_Base::setSlaveReadWriteTransitionEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
uint8_t IMU_MPU_Base::getMasterClockSpeed() {
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
void IMU_MPU_Base::setMasterClockSpeed(uint8_t speed) {
 ...
 */
uint8_t IMU_MPU_Base::getSlaveAddress(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_ADDR
 */
void IMU_MPU_Base::setSlaveAddress(uint8_t num, uint8_t address) {
    if (num > 3) return;
 ...
 */
uint8_t IMU_MPU_Base::getSlaveRegister(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_REG
 */
void IMU_MPU_Base::setSlaveRegister(uint8_t num, uint8_t reg) {
    if (num > 3) return;
 ...
 */
bool IMU_MPU_Base::getSlaveEnabled(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void IMU_MPU_Base::setSlaveEnabled(uint8_t num, bool enabled) {
    if (num > 3) return;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
bool IMU_MPU_Base::getSlaveWordByteSwap(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void IMU_MPU_Base::setSlaveWordByteSwap(uint8_t num, bool enabled) {
    if (num > 3) return;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
bool IMU_MPU_Base::getSlaveWriteMode(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void IMU_MPU_Base::setSlaveWriteMode(uint8_t num, bool mode) {
    if (num > 3) return;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
bool IMU_MPU_Base::getSlaveWordGroupOffset(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void IMU_MPU_Base::setSlaveWordGroupOffset(uint8_t num, bool enabled) {
    if (num > 3) return;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
uint8_t IMU_MPU_Base::getSlaveDataLength(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void IMU_MPU_Base::setSlaveDataLength(uint8_t num, uint8_t length) {
    if (num > 3) return;
 ...
 */
uint8_t IMU_MPU_Base::getSlave4Address() {
 ...
 * @see MPU6050_RA_I2C_SLV4_ADDR
 */
void IMU_MPU_Base::setSlave4Address(uint8_t address) {
 ...
 */
uint8_t IMU_MPU_Base::getSlave4Register() {
 ...
 * @see MPU6050_RA_I2C_SLV4_REG
 */
void IMU_MPU_Base::setSlave4Register(uint8_t reg) {
 ...
 */
void IMU_MPU_Base::setSlave4OutputByte(uint8_t data) {
 ...
 */
bool IMU_MPU_Base::getSlave4Enabled() {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
void IMU_MPU_Base::setSlave4Enabled(bool enabled) {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
bool IMU_MPU_Base::getSlave4InterruptEnabled() {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
void IMU_MPU_Base::setSlave4InterruptEnabled(bool enabled) {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
bool IMU_MPU_Base::getSlave4WriteMode() {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
void IMU_MPU_Base::setSlave4WriteMode(bool mode) {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
uint8_t IMU_MPU_Base::getSlave4MasterDelay() {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
void IMU_MPU_Base::setSlave4MasterDelay(uint8_t delay) {
 ...
 */
uint8_t IMU_MPU_Base::getSlate4InputByte() {
 ...
 */
bool IMU_MPU_Base::getPassthroughStatus() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
bool IMU_MPU_Base::getSlave4IsDone() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
bool IMU_MPU_Base::getLostArbitration() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
bool IMU_MPU_Base::getSlave4Nack() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
bool IMU_MPU_Base::getSlave3Nack() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
bool IMU_MPU_Base::getSlave2Nack() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
bool IMU_MPU_Base::getSlave1Nack() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
bool IMU_MPU_Base::getSlave0Nack() {
 ...
 */
bool IMU_MPU_Base::getInterruptMode() {
 ...
 * @see MPU6050_INTCFG_INT_LEVEL_BIT
 */
void IMU_MPU_Base::setInterruptMode(bool mode) {
 ...
 */
bool IMU_MPU_Base::getInterruptDrive() {
 ...
 * @see MPU6050_INTCFG_INT_OPEN_BIT
 */
void IMU_MPU_Base::setInterruptDrive(bool drive) {
 ...
 */
bool IMU_MPU_Base::getInterruptLatch() {
 ...
 * @see MPU6050_INTCFG_LATCH_INT_EN_BIT
 */
void IMU_MPU_Base::setInterruptLatch(bool latch) {
 ...
 */
bool IMU_MPU_Base::getInterruptLatchClear() {
 ...
 * @see MPU6050_INTCFG_INT_RD_CLEAR_BIT
 */
void IMU_MPU_Base::setInterruptLatchClear(bool clear) {
 ...
 */
bool IMU_MPU_Base::getFSyncInterruptLevel() {
 ...
 * @see MPU6050_INTCFG_FSYNC_INT_LEVEL_BIT
 */
void IMU_MPU_Base::setFSyncInterruptLevel(bool level) {
 ...
 */
bool IMU_MPU_Base::getFSyncInterruptEnabled() {
 ...
 * @see MPU6050_INTCFG_FSYNC_INT_EN_BIT
 */
void IMU_MPU_Base::setFSyncInterruptEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getI2CBypassEnabled() {
 ...
 * @see MPU6050_INTCFG_I2C_BYPASS_EN_BIT
 */
void IMU_MPU_Base::setI2CBypassEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getClockOutputEnabled() {
 ...
 * @see MPU6050_INTCFG_CLKOUT_EN_BIT
 */
void IMU_MPU_Base::setClockOutputEnabled(bool enabled) {
 ...
 **/
uint8_t IMU_MPU_Base::getIntEnabled() {
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 **/
void IMU_MPU_Base::setIntEnabled(uint8_t enabled) {
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 **/
bool IMU_MPU_Base::getIntFreefallEnabled() {
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 **/
void IMU_MPU_Base::setIntFreefallEnabled(bool enabled) {
 ...
 **/
bool IMU_MPU_Base::getIntMotionEnabled() {
 ...
 * @see MPU6050_INTERRUPT_MOT_BIT
 **/
void IMU_MPU_Base::setIntMotionEnabled(bool enabled) {
 ...
 **/
bool IMU_MPU_Base::getIntZeroMotionEnabled() {
 ...
 * @see MPU6050_INTERRUPT_ZMOT_BIT
 **/
void IMU_MPU_Base::setIntZeroMotionEnabled(bool enabled) {
 ...
 **/
bool IMU_MPU_Base::getIntFIFOBufferOverflowEnabled() {
 ...
 * @see MPU6050_INTERRUPT_FIFO_OFLOW_BIT
 **/
void IMU_MPU_Base::setIntFIFOBufferOverflowEnabled(bool enabled) {
 ...
 **/
bool IMU_MPU_Base::getIntI2CMasterEnabled() {
 ...
 * @see MPU6050_INTERRUPT_I2C_MST_INT_BIT
 **/
void IMU_MPU_Base::setIntI2CMasterEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getIntDataReadyEnabled() {
 ...
 * @see MPU6050_INTERRUPT_DATA_RDY_BIT
 */
void IMU_MPU_Base::setIntDataReadyEnabled(bool enabled) {
 ...
 */
uint8_t IMU_MPU_Base::getIntStatus() {
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 */
bool IMU_MPU_Base::getIntFreefallStatus() {
 ...
 * @see MPU6050_INTERRUPT_MOT_BIT
 */
bool IMU_MPU_Base::getIntMotionStatus() {
 ...
 * @see MPU6050_INTERRUPT_ZMOT_BIT
 */
bool IMU_MPU_Base::getIntZeroMotionStatus() {
 ...
 * @see MPU6050_INTERRUPT_FIFO_OFLOW_BIT
 */
bool IMU_MPU_Base::getIntFIFOBufferOverflowStatus() {
 ...
 * @see MPU6050_INTERRUPT_I2C_MST_INT_BIT
 */
bool IMU_MPU_Base::getIntI2CMasterStatus() {
 ...
 * @see MPU6050_INTERRUPT_DATA_RDY_BIT
 */
bool IMU_MPU_Base::getIntDataReadyStatus() {
 ...
 */
void IMU_MPU_Base::getMotion9(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz, int16_t* mx, int16_t* my, int16_t* mz) {
 ...
 * @see MPU6050_RA_ACCEL_XOUT_H
 */
void IMU_MPU_Base::getMotion6(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz) {
 ...
 */
void IMU_MPU_Base::getAcceleration(int16_t* x, int16_t* y, int16_t* z) {
 ...
 * @see MPU6050_RA_ACCEL_XOUT_H
 */
int16_t IMU_MPU_Base::getAccelerationX() {
 ...
 */
int16_t IMU_MPU_Base::getAccelerationY() {
 ...
 */
int16_t IMU_MPU_Base::getAccelerationZ() {
 ...
 */
int16_t IMU_MPU_Base::getTemperature() {
 ...
 * @see MPU6050_RA_GYRO_XOUT_H
 */
void IMU_MPU_Base::getRotation(int16_t* x, int16_t* y, int16_t* z) {
 ...
 * @see MPU6050_RA_GYRO_XOUT_H
 */
int16_t IMU_MPU_Base::getRotationX() {
 ...
 */
int16_t IMU_MPU_Base::getRotationY() {
 ...
 */
int16_t IMU_MPU_Base::getRotationZ() {
 ...
 */
uint8_t IMU_MPU_Base::getExternalSensorByte(int position) {
 ...
 */
uint16_t IMU_MPU_Base::getExternalSensorWord(int position) {
 ...
 * @see getExternalSensorByte()
 */
uint32_t IMU_MPU_Base::getExternalSensorDWord(int position) {
 ...
 */
uint8_t IMU_MPU_Base::getMotionStatus() {
 ...
 */
bool IMU_MPU_Base::getXNegMotionDetected() {
 ...
 */
bool IMU_MPU_Base::getXPosMotionDetected() {
 ...
 */
bool IMU_MPU_Base::getYNegMotionDetected() {
 ...
 */
bool IMU_MPU_Base::getYPosMotionDetected() {
 ...
 */
bool IMU_MPU_Base::getZNegMotionDetected() {
 ...
 */
bool IMU_MPU_Base::getZPosMotionDetected() {
 ...
 */
bool IMU_MPU_Base::getZeroMotionDetected() {
 ...
 */
void IMU_MPU_Base::setSlaveOutputByte(uint8_t num, uint8_t data) {
    if (num > 3) return;
 ...
 */
bool IMU_MPU_Base::getExternalShadowDelayEnabled() {
 ...
 * @see MPU6050_DELAYCTRL_DELAY_ES_SHADOW_BIT
 */
void IMU_MPU_Base::setExternalShadowDelayEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getSlaveDelayEnabled(uint8_t num) {
 ...
 * @see MPU6050_DELAYCTRL_I2C_SLV0_DLY_EN_BIT
 */
void IMU_MPU_Base::setSlaveDelayEnabled(uint8_t num, bool enabled) {
 ...
 */
void IMU_MPU_Base::resetGyroscopePath() {
 ...
 */
void IMU_MPU_Base::resetAccelerometerPath() {
 ...
 */
void IMU_MPU_Base::resetTemperaturePath() {
 ...
 */
uint8_t IMU_MPU_Base::getAccelerometerPowerOnDelay() {
 ...
 * @see MPU6050_DETECT_ACCEL_ON_DELAY_BIT
 */
void IMU_MPU_Base::setAccelerometerPowerOnDelay(uint8_t delay) {
 ...
 */
uint8_t IMU_MPU_Base::getFreefallDetectionCounterDecrement() {
 ...
 * @see MPU6050_DETECT_FF_COUNT_BIT
 */
void IMU_MPU_Base::setFreefallDetectionCounterDecrement(uint8_t decrement) {
 ...
 *
 */
uint8_t IMU_MPU_Base::getMotionDetectionCounterDecrement() {
 ...
 */
void IMU_MPU_Base::setMotionDetectionCounterDecrement(uint8_t decrement) {
 ...
 */
bool IMU_MPU_Base::getFIFOEnabled() {
 ...
 * @see MPU6050_USERCTRL_FIFO_EN_BIT
 */
void IMU_MPU_Base::setFIFOEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getI2CMasterModeEnabled() {
 ...
 * @see MPU6050_USERCTRL_I2C_MST_EN_BIT
 */
void IMU_MPU_Base::setI2CMasterModeEnabled(bool enabled) {
 ...
 */
void IMU_MPU_Base::switchSPIEnabled(bool enabled) {
 ...
 */
void IMU_MPU_Base::resetI2CMaster() {
 ...
 */
void IMU_MPU_Base::resetSensors() {
 ...
 */
bool IMU_MPU_Base::getSleepEnabled() {
 ...
 * @see MPU6050_PWR1_SLEEP_BIT
 */
void IMU_MPU_Base::setSleepEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getWakeCycleEnabled() {
 ...
 * @see MPU6050_PWR1_CYCLE_BIT
 */
void IMU_MPU_Base::setWakeCycleEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getTempSensorEnabled() {
 ...
 * @see MPU6050_PWR1_TEMP_DIS_BIT
 */
void IMU_MPU_Base::setTempSensorEnabled(bool enabled) {
 ...
 */
uint8_t IMU_MPU_Base::getClockSource() {
 ...
 * @see MPU6050_PWR1_CLKSEL_LENGTH
 */
void IMU_MPU_Base::setClockSource(uint8_t source) {
 ...
 */
uint8_t IMU_MPU_Base::getWakeFrequency() {
 ...
 * @see MPU6050_RA_PWR_MGMT_2
 */
void IMU_MPU_Base::setWakeFrequency(uint8_t frequency) {
 ...
 */
bool IMU_MPU_Base::getStandbyXAccelEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_XA_BIT
 */
void IMU_MPU_Base::setStandbyXAccelEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getStandbyYAccelEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_YA_BIT
 */
void IMU_MPU_Base::setStandbyYAccelEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getStandbyZAccelEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_ZA_BIT
 */
void IMU_MPU_Base::setStandbyZAccelEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getStandbyXGyroEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_XG_BIT
 */
void IMU_MPU_Base::setStandbyXGyroEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getStandbyYGyroEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_YG_BIT
 */
void IMU_MPU_Base::setStandbyYGyroEnabled(bool enabled) {
 ...
 */
bool IMU_MPU_Base::getStandbyZGyroEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_ZG_BIT
 */
void IMU_MPU_Base::setStandbyZGyroEnabled(bool enabled) {
 ...
 */
uint16_t IMU_MPU_Base::getFIFOCount() {
 ...
 */
uint8_t IMU_MPU_Base::getFIFOByte() {
    I2Cdev::readByte(devAddr, MPU6050_RA_FIFO_R_W, buffer);
    return buffer[0];
}
void IMU_MPU_Base::getFIFOBytes(uint8_t *data, uint8_t length) {
    if(length > 0){
 ...
 * ================================================================ */
 int8_t IMU_MPU_Base::GetCurrentFIFOPacket(uint8_t *data, uint8_t length) { // overflow proof
     int16_t fifoC;
 ...
 */
void IMU_MPU_Base::setFIFOByte(uint8_t data) {
 ...
 */
uint8_t IMU_MPU_Base::getDeviceID() {
 ...
 * @see MPU6050_WHO_AM_I_LENGTH
 */
void IMU_MPU_Base::setDeviceID(uint8_t id) {
...
int16_t IMU_MPU_Base::getYAccelOffset() {
	uint8_t SaveAddress = ((getDeviceID() < 0x38 )? MPU6050_RA_YA_OFFS_H:0x7A); // IMU_MPU_Base,MPU9150 Vs MPU6500,MPU9250
	I2Cdev::readBytes(devAddr, SaveAddress, 2, buffer);
	return (((int16_t)buffer[0]) << 8) | buffer[1];
}
void IMU_MPU_Base::setYAccelOffset(int16_t offset) {
	uint8_t SaveAddress = ((getDeviceID() < 0x38 )? MPU6050_RA_YA_OFFS_H:0x7A); // IMU_MPU_Base,MPU9150 Vs MPU6500,MPU9250
	I2Cdev::writeWord(devAddr, SaveAddress, offset);
}
...
int16_t IMU_MPU_Base::getZAccelOffset() {
	uint8_t SaveAddress = ((getDeviceID() < 0x38 )? MPU6050_RA_ZA_OFFS_H:0x7D); // IMU_MPU_Base,MPU9150 Vs MPU6500,MPU9250
	I2Cdev::readBytes(devAddr, SaveAddress, 2, buffer);
	return (((int16_t)buffer[0]) << 8) | buffer[1];
}
void IMU_MPU_Base::setZAccelOffset(int16_t offset) {
	uint8_t SaveAddress = ((getDeviceID() < 0x38 )? MPU6050_RA_ZA_OFFS_H:0x7D); // IMU_MPU_Base,MPU9150 Vs MPU6500,MPU9250
	I2Cdev::writeWord(devAddr, SaveAddress, offset);
}
...
bool IMU_MPU_Base::getDMPEnabled() {
    I2Cdev::readBit(devAddr, MPU6050_RA_USER_CTRL, MPU6050_USERCTRL_DMP_EN_BIT, buffer);
    return buffer[0];
}
void IMU_MPU_Base::setDMPEnabled(bool enabled) {
    I2Cdev::writeBit(devAddr, MPU6050_RA_USER_CTRL, MPU6050_USERCTRL_DMP_EN_BIT, enabled);
}
void IMU_MPU_Base::resetDMP() {
    I2Cdev::writeBit(devAddr, MPU6050_RA_USER_CTRL, MPU6050_USERCTRL_DMP_RESET_BIT, true);
}

// BANK_SEL register

void IMU_MPU_Base::setMemoryBank(uint8_t bank, bool prefetchEnabled, bool userBank) {
    bank &= 0x1F;
...
void IMU_MPU_Base::setMemoryStartAddress(uint8_t address) {
    I2Cdev::writeByte(devAddr, MPU6050_RA_MEM_START_ADDR, address);
}

// MEM_R_W register

uint8_t IMU_MPU_Base::readMemoryByte() {
    I2Cdev::readByte(devAddr, MPU6050_RA_MEM_R_W, buffer);
    return buffer[0];
}
void IMU_MPU_Base::writeMemoryByte(uint8_t data) {
    I2Cdev::writeByte(devAddr, MPU6050_RA_MEM_R_W, data);
}
void IMU_MPU_Base::readMemoryBlock(uint8_t *data, uint16_t dataSize, uint8_t bank, uint8_t address) {
    setMemoryBank(bank);
...
bool IMU_MPU_Base::writeMemoryBlock(const uint8_t *data, uint16_t dataSize, uint8_t bank, uint8_t address, bool verify, bool useProgMem) {
    setMemoryBank(bank);
    setMemoryStartAddress(address);
    uint8_t chunkSize;
...
bool IMU_MPU_Base::writeProgMemoryBlock(const uint8_t *data, uint16_t dataSize, uint8_t bank, uint8_t address, bool verify) {
    return writeMemoryBlock(data, dataSize, bank, address, verify, true);
}
bool IMU_MPU_Base::writeDMPConfigurationSet(const uint8_t *data, uint16_t dataSize, bool useProgMem) {
    uint8_t *progBuffer = 0;
...
bool IMU_MPU_Base::writeProgDMPConfigurationSet(const uint8_t *data, uint16_t dataSize) {
    return writeDMPConfigurationSet(data, dataSize, true);
}

// DMP_CFG_1 register

uint8_t IMU_MPU_Base::getDMPConfig1() {
    I2Cdev::readByte(devAddr, MPU6050_RA_DMP_CFG_1, buffer);
    return buffer[0];
}
void IMU_MPU_Base::setDMPConfig1(uint8_t config) {
    I2Cdev::writeByte(devAddr, MPU6050_RA_DMP_CFG_1, config);
}

// DMP_CFG_2 register

uint8_t IMU_MPU_Base::getDMPConfig2() {
    I2Cdev::readByte(devAddr, MPU6050_RA_DMP_CFG_2, buffer);
    return buffer[0];
}
void IMU_MPU_Base::setDMPConfig2(uint8_t config) {
...
*/
void IMU_MPU_Base::CalibrateGyro(uint8_t Loops ) {
  double kP = 0.3;
  double kI = 90;
  float x;
...
*/
void IMU_MPU_Base::CalibrateAccel(uint8_t Loops ) {
...
void IMU_MPU_Base::PID(uint8_t ReadAddress, float kP,float kI, uint8_t Loops){
...
void IMU_MPU_Base::PrintActiveOffsets() {
